...
_CORBA_MODULE_BEG
  ...
  typedef ::CORBA::Double DblArray4[4];
  typedef ::CORBA::Double DblArray4_slice;

  _CORBA_MODULE_INLINE DblArray4_slice* DblArray4_alloc() {
    return new DblArray4_slice[4];
  }

  _CORBA_MODULE_INLINE DblArray4_slice* DblArray4_dup(const DblArray4_slice* _s) {
    if (!_s) return 0;
    DblArray4_slice* _data = DblArray4_alloc();
    if (_data) {
  ...
  _CORBA_MODULE_INLINE void DblArray4_copy(DblArray4_slice* _to, const DblArray4_slice* _from){
    for (_CORBA_ULong _0i0 = 0; _0i0 < 4; _0i0++){
  ...
  _CORBA_MODULE_INLINE void DblArray4_free(DblArray4_slice* _s) {
    delete [] _s;
  }

  class DblArray4_copyHelper {
  public:
    static inline DblArray4_slice* alloc() { return ::OpenHRP::DblArray4_alloc(); }
    static inline DblArray4_slice* dup(const DblArray4_slice* p) { return ::OpenHRP::DblArray4_dup(p); }
    static inline void free(DblArray4_slice* p) { ::OpenHRP::DblArray4_free(p); }
  };

  typedef _CORBA_Array_Fix_Var<DblArray4_copyHelper,DblArray4_slice> DblArray4_var;
  typedef _CORBA_Array_Fix_Forany<DblArray4_copyHelper,DblArray4_slice> DblArray4_forany;

  typedef DblArray4_slice* DblArray4_out;

  typedef ::CORBA::Float FloatArray3[3];
  typedef ::CORBA::Float FloatArray3_slice;

  _CORBA_MODULE_INLINE FloatArray3_slice* FloatArray3_alloc() {
    return new FloatArray3_slice[3];
  }

  _CORBA_MODULE_INLINE FloatArray3_slice* FloatArray3_dup(const FloatArray3_slice* _s) {
    if (!_s) return 0;
    FloatArray3_slice* _data = FloatArray3_alloc();
    if (_data) {
  ...
  _CORBA_MODULE_INLINE void FloatArray3_copy(FloatArray3_slice* _to, const FloatArray3_slice* _from){
    for (_CORBA_ULong _0i0 = 0; _0i0 < 3; _0i0++){
  ...
  _CORBA_MODULE_INLINE void FloatArray3_free(FloatArray3_slice* _s) {
    delete [] _s;
  }

  class FloatArray3_copyHelper {
  public:
    static inline FloatArray3_slice* alloc() { return ::OpenHRP::FloatArray3_alloc(); }
    static inline FloatArray3_slice* dup(const FloatArray3_slice* p) { return ::OpenHRP::FloatArray3_dup(p); }
    static inline void free(FloatArray3_slice* p) { ::OpenHRP::FloatArray3_free(p); }
  };

  typedef _CORBA_Array_Fix_Var<FloatArray3_copyHelper,FloatArray3_slice> FloatArray3_var;
  typedef _CORBA_Array_Fix_Forany<FloatArray3_copyHelper,FloatArray3_slice> FloatArray3_forany;

  typedef FloatArray3_slice* FloatArray3_out;
  ...
  public:
    static inline DblArray3_slice* alloc() { return ::OpenHRP::DblArray3_alloc(); }
    static inline DblArray3_slice* dup(const DblArray3_slice* p) { return ::OpenHRP::DblArray3_dup(p); }
    static inline void free(DblArray3_slice* p) { ::OpenHRP::DblArray3_free(p); }
  };
  ...
  public:
    static inline DblArray6_slice* alloc() { return ::OpenHRP::DblArray6_alloc(); }
    static inline DblArray6_slice* dup(const DblArray6_slice* p) { return ::OpenHRP::DblArray6_dup(p); }
    static inline void free(DblArray6_slice* p) { ::OpenHRP::DblArray6_free(p); }
  };
  ...
  public:
    static inline DblArray9_slice* alloc() { return ::OpenHRP::DblArray9_alloc(); }
    static inline DblArray9_slice* dup(const DblArray9_slice* p) { return ::OpenHRP::DblArray9_dup(p); }
    static inline void free(DblArray9_slice* p) { ::OpenHRP::DblArray9_free(p); }
  };
  ...
  typedef ::CORBA::Double DblArray12[12];
  typedef ::CORBA::Double DblArray12_slice;

  _CORBA_MODULE_INLINE DblArray12_slice* DblArray12_alloc() {
    return new DblArray12_slice[12];
  }

  _CORBA_MODULE_INLINE DblArray12_slice* DblArray12_dup(const DblArray12_slice* _s) {
    if (!_s) return 0;
    DblArray12_slice* _data = DblArray12_alloc();
    if (_data) {
  ...
  _CORBA_MODULE_INLINE void DblArray12_copy(DblArray12_slice* _to, const DblArray12_slice* _from){
    for (_CORBA_ULong _0i0 = 0; _0i0 < 12; _0i0++){
  ...
  _CORBA_MODULE_INLINE void DblArray12_free(DblArray12_slice* _s) {
    delete [] _s;
  }

  class DblArray12_copyHelper {
  public:
    static inline DblArray12_slice* alloc() { return ::OpenHRP::DblArray12_alloc(); }
    static inline DblArray12_slice* dup(const DblArray12_slice* p) { return ::OpenHRP::DblArray12_dup(p); }
    static inline void free(DblArray12_slice* p) { ::OpenHRP::DblArray12_free(p); }
  };

  typedef _CORBA_Array_Fix_Var<DblArray12_copyHelper,DblArray12_slice> DblArray12_var;
  typedef _CORBA_Array_Fix_Forany<DblArray12_copyHelper,DblArray12_slice> DblArray12_forany;

  typedef DblArray12_slice* DblArray12_out;
  ...
  class DblArray3Sequence_var;

  class DblArray3Sequence : public _CORBA_Unbounded_Sequence_Array_w_FixSizeElement< DblArray3, DblArray3_slice, ::CORBA::Double, 3, 8, 8 >  {
  public:
    typedef DblArray3Sequence_var _var_type;
    inline DblArray3Sequence() {}
    inline DblArray3Sequence(const DblArray3Sequence& _s)
      : _CORBA_Unbounded_Sequence_Array_w_FixSizeElement< DblArray3, DblArray3_slice, ::CORBA::Double, 3, 8, 8 > (_s) {}

    inline DblArray3Sequence(_CORBA_ULong _max)
      : _CORBA_Unbounded_Sequence_Array_w_FixSizeElement< DblArray3, DblArray3_slice, ::CORBA::Double, 3, 8, 8 > (_max) {}
    inline DblArray3Sequence(_CORBA_ULong _max, _CORBA_ULong _len, DblArray3* _val, _CORBA_Boolean _rel=0)
      : _CORBA_Unbounded_Sequence_Array_w_FixSizeElement< DblArray3, DblArray3_slice, ::CORBA::Double, 3, 8, 8 > (_max, _len, _val, _rel) {}

  

    inline DblArray3Sequence& operator = (const DblArray3Sequence& _s) {
      _CORBA_Unbounded_Sequence_Array_w_FixSizeElement< DblArray3, DblArray3_slice, ::CORBA::Double, 3, 8, 8 > ::operator=(_s);
      return *this;
    }
  };

  class DblArray3Sequence_out;

  class DblArray3Sequence_var {
  public:
    inline DblArray3Sequence_var() : _pd_seq(0) {}
    inline DblArray3Sequence_var(DblArray3Sequence* _s) : _pd_seq(_s) {}
    inline DblArray3Sequence_var(const DblArray3Sequence_var& _s) {
      if( _s._pd_seq )  _pd_seq = new DblArray3Sequence(*_s._pd_seq);
      else              _pd_seq = 0;
    }
    inline ~DblArray3Sequence_var() { if( _pd_seq )  delete _pd_seq; }
      
    inline DblArray3Sequence_var& operator = (DblArray3Sequence* _s) {
      if( _pd_seq )  delete _pd_seq;
      _pd_seq = _s;
      return *this;
    }
    inline DblArray3Sequence_var& operator = (const DblArray3Sequence_var& _s) {
      if( _s._pd_seq ) {
        if( !_pd_seq )  _pd_seq = new DblArray3Sequence;
        *_pd_seq = *_s._pd_seq;
      } else if( _pd_seq ) {
        delete _pd_seq;
        _pd_seq = 0;
    ...
    inline DblArray3_slice* operator [] (_CORBA_ULong _s) {
      return (DblArray3_slice*) ((_pd_seq->NP_data())[_s]);
    }

  

    inline DblArray3Sequence* operator -> () { return _pd_seq; }
    inline const DblArray3Sequence* operator -> () const { return _pd_seq; }
#if defined(__GNUG__)
    inline operator DblArray3Sequence& () const { return *_pd_seq; }
#else
    inline operator const DblArray3Sequence& () const { return *_pd_seq; }
    inline operator DblArray3Sequence& () { return *_pd_seq; }
#endif
      
    inline const DblArray3Sequence& in() const { return *_pd_seq; }
    inline DblArray3Sequence&       inout()    { return *_pd_seq; }
    inline DblArray3Sequence*&      out() {
      if( _pd_seq ) { delete _pd_seq; _pd_seq = 0; }
      return _pd_seq;
    }
    inline DblArray3Sequence* _retn() { DblArray3Sequence* tmp = _pd_seq; _pd_seq = 0; return tmp; }
      
    friend class DblArray3Sequence_out;
    
  private:
    DblArray3Sequence* _pd_seq;
  };

  class DblArray3Sequence_out {
  public:
    inline DblArray3Sequence_out(DblArray3Sequence*& _s) : _data(_s) { _data = 0; }
    inline DblArray3Sequence_out(DblArray3Sequence_var& _s)
      : _data(_s._pd_seq) { _s = (DblArray3Sequence*) 0; }
    inline DblArray3Sequence_out(const DblArray3Sequence_out& _s) : _data(_s._data) {}
    inline DblArray3Sequence_out& operator = (const DblArray3Sequence_out& _s) {
      _data = _s._data;
      return *this;
    }
    inline DblArray3Sequence_out& operator = (DblArray3Sequence* _s) {
      _data = _s;
      return *this;
    }
    inline operator DblArray3Sequence*&()  { return _data; }
    inline DblArray3Sequence*& ptr()       { return _data; }
    inline DblArray3Sequence* operator->() { return _data; }

    inline DblArray3_slice* operator [] (_CORBA_ULong _i) {
      return (DblArray3_slice*) ((_data->NP_data())[_i]);
    }

  

    DblArray3Sequence*& _data;

  private:
    DblArray3Sequence_out();
    DblArray3Sequence_out& operator=(const DblArray3Sequence_var&);
  };

  class DblArray6Sequence_var;

  class DblArray6Sequence : public _CORBA_Unbounded_Sequence_Array_w_FixSizeElement< DblArray6, DblArray6_slice, ::CORBA::Double, 6, 8, 8 >  {
  public:
    typedef DblArray6Sequence_var _var_type;
    inline DblArray6Sequence() {}
    inline DblArray6Sequence(const DblArray6Sequence& _s)
      : _CORBA_Unbounded_Sequence_Array_w_FixSizeElement< DblArray6, DblArray6_slice, ::CORBA::Double, 6, 8, 8 > (_s) {}

    inline DblArray6Sequence(_CORBA_ULong _max)
      : _CORBA_Unbounded_Sequence_Array_w_FixSizeElement< DblArray6, DblArray6_slice, ::CORBA::Double, 6, 8, 8 > (_max) {}
    inline DblArray6Sequence(_CORBA_ULong _max, _CORBA_ULong _len, DblArray6* _val, _CORBA_Boolean _rel=0)
      : _CORBA_Unbounded_Sequence_Array_w_FixSizeElement< DblArray6, DblArray6_slice, ::CORBA::Double, 6, 8, 8 > (_max, _len, _val, _rel) {}

  

    inline DblArray6Sequence& operator = (const DblArray6Sequence& _s) {
      _CORBA_Unbounded_Sequence_Array_w_FixSizeElement< DblArray6, DblArray6_slice, ::CORBA::Double, 6, 8, 8 > ::operator=(_s);
      return *this;
    }
  };

  class DblArray6Sequence_out;

  class DblArray6Sequence_var {
  public:
    inline DblArray6Sequence_var() : _pd_seq(0) {}
    inline DblArray6Sequence_var(DblArray6Sequence* _s) : _pd_seq(_s) {}
    inline DblArray6Sequence_var(const DblArray6Sequence_var& _s) {
      if( _s._pd_seq )  _pd_seq = new DblArray6Sequence(*_s._pd_seq);
      else              _pd_seq = 0;
    }
    inline ~DblArray6Sequence_var() { if( _pd_seq )  delete _pd_seq; }
      
    inline DblArray6Sequence_var& operator = (DblArray6Sequence* _s) {
      if( _pd_seq )  delete _pd_seq;
      _pd_seq = _s;
      return *this;
    }
    inline DblArray6Sequence_var& operator = (const DblArray6Sequence_var& _s) {
      if( _s._pd_seq ) {
        if( !_pd_seq )  _pd_seq = new DblArray6Sequence;
        *_pd_seq = *_s._pd_seq;
      } else if( _pd_seq ) {
        delete _pd_seq;
        _pd_seq = 0;
    ...
    inline DblArray6_slice* operator [] (_CORBA_ULong _s) {
      return (DblArray6_slice*) ((_pd_seq->NP_data())[_s]);
    }

  

    inline DblArray6Sequence* operator -> () { return _pd_seq; }
    inline const DblArray6Sequence* operator -> () const { return _pd_seq; }
#if defined(__GNUG__)
    inline operator DblArray6Sequence& () const { return *_pd_seq; }
#else
    inline operator const DblArray6Sequence& () const { return *_pd_seq; }
    inline operator DblArray6Sequence& () { return *_pd_seq; }
#endif
      
    inline const DblArray6Sequence& in() const { return *_pd_seq; }
    inline DblArray6Sequence&       inout()    { return *_pd_seq; }
    inline DblArray6Sequence*&      out() {
      if( _pd_seq ) { delete _pd_seq; _pd_seq = 0; }
      return _pd_seq;
    }
    inline DblArray6Sequence* _retn() { DblArray6Sequence* tmp = _pd_seq; _pd_seq = 0; return tmp; }
      
    friend class DblArray6Sequence_out;
    
  private:
    DblArray6Sequence* _pd_seq;
  };

  class DblArray6Sequence_out {
  public:
    inline DblArray6Sequence_out(DblArray6Sequence*& _s) : _data(_s) { _data = 0; }
    inline DblArray6Sequence_out(DblArray6Sequence_var& _s)
      : _data(_s._pd_seq) { _s = (DblArray6Sequence*) 0; }
    inline DblArray6Sequence_out(const DblArray6Sequence_out& _s) : _data(_s._data) {}
    inline DblArray6Sequence_out& operator = (const DblArray6Sequence_out& _s) {
      _data = _s._data;
      return *this;
    }
    inline DblArray6Sequence_out& operator = (DblArray6Sequence* _s) {
      _data = _s;
      return *this;
    }
    inline operator DblArray6Sequence*&()  { return _data; }
    inline DblArray6Sequence*& ptr()       { return _data; }
    inline DblArray6Sequence* operator->() { return _data; }

    inline DblArray6_slice* operator [] (_CORBA_ULong _i) {
      return (DblArray6_slice*) ((_data->NP_data())[_i]);
    }

  

    DblArray6Sequence*& _data;

  private:
    DblArray6Sequence_out();
    DblArray6Sequence_out& operator=(const DblArray6Sequence_var&);
  };

  class DblArray12Sequence_var;

  class DblArray12Sequence : public _CORBA_Unbounded_Sequence_Array_w_FixSizeElement< DblArray12, DblArray12_slice, ::CORBA::Double, 12, 8, 8 >  {
  public:
    typedef DblArray12Sequence_var _var_type;
    inline DblArray12Sequence() {}
    inline DblArray12Sequence(const DblArray12Sequence& _s)
      : _CORBA_Unbounded_Sequence_Array_w_FixSizeElement< DblArray12, DblArray12_slice, ::CORBA::Double, 12, 8, 8 > (_s) {}

    inline DblArray12Sequence(_CORBA_ULong _max)
      : _CORBA_Unbounded_Sequence_Array_w_FixSizeElement< DblArray12, DblArray12_slice, ::CORBA::Double, 12, 8, 8 > (_max) {}
    inline DblArray12Sequence(_CORBA_ULong _max, _CORBA_ULong _len, DblArray12* _val, _CORBA_Boolean _rel=0)
      : _CORBA_Unbounded_Sequence_Array_w_FixSizeElement< DblArray12, DblArray12_slice, ::CORBA::Double, 12, 8, 8 > (_max, _len, _val, _rel) {}

  

    inline DblArray12Sequence& operator = (const DblArray12Sequence& _s) {
      _CORBA_Unbounded_Sequence_Array_w_FixSizeElement< DblArray12, DblArray12_slice, ::CORBA::Double, 12, 8, 8 > ::operator=(_s);
      return *this;
    }
  };

  class DblArray12Sequence_out;

  class DblArray12Sequence_var {
  public:
    inline DblArray12Sequence_var() : _pd_seq(0) {}
    inline DblArray12Sequence_var(DblArray12Sequence* _s) : _pd_seq(_s) {}
    inline DblArray12Sequence_var(const DblArray12Sequence_var& _s) {
      if( _s._pd_seq )  _pd_seq = new DblArray12Sequence(*_s._pd_seq);
      else              _pd_seq = 0;
    }
    inline ~DblArray12Sequence_var() { if( _pd_seq )  delete _pd_seq; }
      
    inline DblArray12Sequence_var& operator = (DblArray12Sequence* _s) {
      if( _pd_seq )  delete _pd_seq;
      _pd_seq = _s;
      return *this;
    }
    inline DblArray12Sequence_var& operator = (const DblArray12Sequence_var& _s) {
      if( _s._pd_seq ) {
        if( !_pd_seq )  _pd_seq = new DblArray12Sequence;
        *_pd_seq = *_s._pd_seq;
      } else if( _pd_seq ) {
        delete _pd_seq;
        _pd_seq = 0;
    ...
    inline DblArray12_slice* operator [] (_CORBA_ULong _s) {
      return (DblArray12_slice*) ((_pd_seq->NP_data())[_s]);
    }

  

    inline DblArray12Sequence* operator -> () { return _pd_seq; }
    inline const DblArray12Sequence* operator -> () const { return _pd_seq; }
#if defined(__GNUG__)
    inline operator DblArray12Sequence& () const { return *_pd_seq; }
#else
    inline operator const DblArray12Sequence& () const { return *_pd_seq; }
    inline operator DblArray12Sequence& () { return *_pd_seq; }
#endif
      
    inline const DblArray12Sequence& in() const { return *_pd_seq; }
    inline DblArray12Sequence&       inout()    { return *_pd_seq; }
    inline DblArray12Sequence*&      out() {
      if( _pd_seq ) { delete _pd_seq; _pd_seq = 0; }
      return _pd_seq;
    }
    inline DblArray12Sequence* _retn() { DblArray12Sequence* tmp = _pd_seq; _pd_seq = 0; return tmp; }
      
    friend class DblArray12Sequence_out;
    
  private:
    DblArray12Sequence* _pd_seq;
  };

  class DblArray12Sequence_out {
  public:
    inline DblArray12Sequence_out(DblArray12Sequence*& _s) : _data(_s) { _data = 0; }
    inline DblArray12Sequence_out(DblArray12Sequence_var& _s)
      : _data(_s._pd_seq) { _s = (DblArray12Sequence*) 0; }
    inline DblArray12Sequence_out(const DblArray12Sequence_out& _s) : _data(_s._data) {}
    inline DblArray12Sequence_out& operator = (const DblArray12Sequence_out& _s) {
      _data = _s._data;
      return *this;
    }
    inline DblArray12Sequence_out& operator = (DblArray12Sequence* _s) {
      _data = _s;
      return *this;
    }
    inline operator DblArray12Sequence*&()  { return _data; }
    inline DblArray12Sequence*& ptr()       { return _data; }
    inline DblArray12Sequence* operator->() { return _data; }

    inline DblArray12_slice* operator [] (_CORBA_ULong _i) {
      return (DblArray12_slice*) ((_data->NP_data())[_i]);
    }

  

    DblArray12Sequence*& _data;

  private:
    DblArray12Sequence_out();
    DblArray12Sequence_out& operator=(const DblArray12Sequence_var&);
  };

  class DblSequenceSequence_var;

  class DblSequenceSequence : public _CORBA_Unbounded_Sequence< DblSequence >  {
  public:
    typedef DblSequenceSequence_var _var_type;
    inline DblSequenceSequence() {}
    inline DblSequenceSequence(const DblSequenceSequence& _s)
      : _CORBA_Unbounded_Sequence< DblSequence > (_s) {}

    inline DblSequenceSequence(_CORBA_ULong _max)
      : _CORBA_Unbounded_Sequence< DblSequence > (_max) {}
    inline DblSequenceSequence(_CORBA_ULong _max, _CORBA_ULong _len, DblSequence* _val, _CORBA_Boolean _rel=0)
      : _CORBA_Unbounded_Sequence< DblSequence > (_max, _len, _val, _rel) {}

  

    inline DblSequenceSequence& operator = (const DblSequenceSequence& _s) {
      _CORBA_Unbounded_Sequence< DblSequence > ::operator=(_s);
      return *this;
    }
  };

  class DblSequenceSequence_out;

  class DblSequenceSequence_var {
  public:
    inline DblSequenceSequence_var() : _pd_seq(0) {}
    inline DblSequenceSequence_var(DblSequenceSequence* _s) : _pd_seq(_s) {}
    inline DblSequenceSequence_var(const DblSequenceSequence_var& _s) {
      if( _s._pd_seq )  _pd_seq = new DblSequenceSequence(*_s._pd_seq);
      else              _pd_seq = 0;
    }
    inline ~DblSequenceSequence_var() { if( _pd_seq )  delete _pd_seq; }
      
    inline DblSequenceSequence_var& operator = (DblSequenceSequence* _s) {
      if( _pd_seq )  delete _pd_seq;
      _pd_seq = _s;
      return *this;
    }
    inline DblSequenceSequence_var& operator = (const DblSequenceSequence_var& _s) {
      if( _s._pd_seq ) {
        if( !_pd_seq )  _pd_seq = new DblSequenceSequence;
        *_pd_seq = *_s._pd_seq;
      } else if( _pd_seq ) {
        delete _pd_seq;
        _pd_seq = 0;
    ...
    inline DblSequence& operator [] (_CORBA_ULong _s) {
      return (*_pd_seq)[_s];
    }

  

    inline DblSequenceSequence* operator -> () { return _pd_seq; }
    inline const DblSequenceSequence* operator -> () const { return _pd_seq; }
#if defined(__GNUG__)
    inline operator DblSequenceSequence& () const { return *_pd_seq; }
#else
    inline operator const DblSequenceSequence& () const { return *_pd_seq; }
    inline operator DblSequenceSequence& () { return *_pd_seq; }
#endif
      
    inline const DblSequenceSequence& in() const { return *_pd_seq; }
    inline DblSequenceSequence&       inout()    { return *_pd_seq; }
    inline DblSequenceSequence*&      out() {
      if( _pd_seq ) { delete _pd_seq; _pd_seq = 0; }
      return _pd_seq;
    }
    inline DblSequenceSequence* _retn() { DblSequenceSequence* tmp = _pd_seq; _pd_seq = 0; return tmp; }
      
    friend class DblSequenceSequence_out;
    
  private:
    DblSequenceSequence* _pd_seq;
  };

  class DblSequenceSequence_out {
  public:
    inline DblSequenceSequence_out(DblSequenceSequence*& _s) : _data(_s) { _data = 0; }
    inline DblSequenceSequence_out(DblSequenceSequence_var& _s)
      : _data(_s._pd_seq) { _s = (DblSequenceSequence*) 0; }
    inline DblSequenceSequence_out(const DblSequenceSequence_out& _s) : _data(_s._data) {}
    inline DblSequenceSequence_out& operator = (const DblSequenceSequence_out& _s) {
      _data = _s._data;
      return *this;
    }
    inline DblSequenceSequence_out& operator = (DblSequenceSequence* _s) {
      _data = _s;
      return *this;
    }
    inline operator DblSequenceSequence*&()  { return _data; }
    inline DblSequenceSequence*& ptr()       { return _data; }
    inline DblSequenceSequence* operator->() { return _data; }

    inline DblSequence& operator [] (_CORBA_ULong _i) {
      return (*_data)[_i];
    }

  

    DblSequenceSequence*& _data;

  private:
    DblSequenceSequence_out();
    DblSequenceSequence_out& operator=(const DblSequenceSequence_var&);
  };
  ...
  struct Distance {
    typedef _CORBA_ConstrType_Variable_Var<Distance> _var_type;
  ...
  typedef Distance::_var_type Distance_var;

  typedef _CORBA_ConstrType_Variable_OUT_arg< Distance,Distance_var > Distance_out;

  class DistanceSequence_var;

  class DistanceSequence : public _CORBA_Unbounded_Sequence< Distance >  {
  public:
    typedef DistanceSequence_var _var_type;
    inline DistanceSequence() {}
    inline DistanceSequence(const DistanceSequence& _s)
      : _CORBA_Unbounded_Sequence< Distance > (_s) {}

    inline DistanceSequence(_CORBA_ULong _max)
      : _CORBA_Unbounded_Sequence< Distance > (_max) {}
    inline DistanceSequence(_CORBA_ULong _max, _CORBA_ULong _len, Distance* _val, _CORBA_Boolean _rel=0)
      : _CORBA_Unbounded_Sequence< Distance > (_max, _len, _val, _rel) {}

  

    inline DistanceSequence& operator = (const DistanceSequence& _s) {
      _CORBA_Unbounded_Sequence< Distance > ::operator=(_s);
      return *this;
    }
  };

  class DistanceSequence_out;

  class DistanceSequence_var {
  public:
    inline DistanceSequence_var() : _pd_seq(0) {}
    inline DistanceSequence_var(DistanceSequence* _s) : _pd_seq(_s) {}
    inline DistanceSequence_var(const DistanceSequence_var& _s) {
      if( _s._pd_seq )  _pd_seq = new DistanceSequence(*_s._pd_seq);
      else              _pd_seq = 0;
    }
    inline ~DistanceSequence_var() { if( _pd_seq )  delete _pd_seq; }
      
    inline DistanceSequence_var& operator = (DistanceSequence* _s) {
      if( _pd_seq )  delete _pd_seq;
      _pd_seq = _s;
      return *this;
    }
    inline DistanceSequence_var& operator = (const DistanceSequence_var& _s) {
      if( _s._pd_seq ) {
        if( !_pd_seq )  _pd_seq = new DistanceSequence;
        *_pd_seq = *_s._pd_seq;
      } else if( _pd_seq ) {
        delete _pd_seq;
        _pd_seq = 0;
    ...
    inline Distance& operator [] (_CORBA_ULong _s) {
      return (*_pd_seq)[_s];
    }

  

    inline DistanceSequence* operator -> () { return _pd_seq; }
    inline const DistanceSequence* operator -> () const { return _pd_seq; }
#if defined(__GNUG__)
    inline operator DistanceSequence& () const { return *_pd_seq; }
#else
    inline operator const DistanceSequence& () const { return *_pd_seq; }
    inline operator DistanceSequence& () { return *_pd_seq; }
#endif
      
    inline const DistanceSequence& in() const { return *_pd_seq; }
    inline DistanceSequence&       inout()    { return *_pd_seq; }
    inline DistanceSequence*&      out() {
      if( _pd_seq ) { delete _pd_seq; _pd_seq = 0; }
      return _pd_seq;
    }
    inline DistanceSequence* _retn() { DistanceSequence* tmp = _pd_seq; _pd_seq = 0; return tmp; }
      
    friend class DistanceSequence_out;
    
  private:
    DistanceSequence* _pd_seq;
  };

  class DistanceSequence_out {
  public:
    inline DistanceSequence_out(DistanceSequence*& _s) : _data(_s) { _data = 0; }
    inline DistanceSequence_out(DistanceSequence_var& _s)
      : _data(_s._pd_seq) { _s = (DistanceSequence*) 0; }
    inline DistanceSequence_out(const DistanceSequence_out& _s) : _data(_s._data) {}
    inline DistanceSequence_out& operator = (const DistanceSequence_out& _s) {
      _data = _s._data;
      return *this;
    }
    inline DistanceSequence_out& operator = (DistanceSequence* _s) {
      _data = _s;
      return *this;
    }
    inline operator DistanceSequence*&()  { return _data; }
    inline DistanceSequence*& ptr()       { return _data; }
    inline DistanceSequence* operator->() { return _data; }

    inline Distance& operator [] (_CORBA_ULong _i) {
      return (*_data)[_i];
    }

  

    DistanceSequence*& _data;

  private:
    DistanceSequence_out();
    DistanceSequence_out& operator=(const DistanceSequence_var&);
  };
...
#define __OpenHRP_mServerObject__
  ...
  enum ExtraJointType { EJ_XYZ, EJ_XY, EJ_Z /*, __max_ExtraJointType=0xffffffff */ };
  typedef ExtraJointType& ExtraJointType_out;
...
inline void operator >>=(OpenHRP::ExtraJointType _e, cdrStream& s) {
...
inline void operator <<= (OpenHRP::ExtraJointType& _e, cdrStream& s) {
  ::CORBA::ULong _0RL_e;
  ::operator<<=(_0RL_e,s);
  if (_0RL_e <= OpenHRP::EJ_Z) {
    _e = (OpenHRP::ExtraJointType) _0RL_e;
  }
  else {
